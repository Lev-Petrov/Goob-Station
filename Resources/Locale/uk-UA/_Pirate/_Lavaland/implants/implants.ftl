...
ent-DeathRattleLavalandImplant = Останній Подих
    .desc = Цей імплант сповістить локальний канал постачання та станційний медичний відділ, якщо носій помре. Сигнал досягає станції й передає точні координати смерті.
